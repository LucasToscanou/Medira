...
function main() {
    let sampleWeights = generateFloatArray(10, 90, 115).sort((a, b) => b.date.getTime() - a.date.getTime());
    ...
    if (weightHistoryTable) {
        tableContainer === null || tableContainer === void 0 ? void 0 : tableContainer.appendChild(weightHistoryTable.table);
    }
}
main();
